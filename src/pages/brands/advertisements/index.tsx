...
export default function BrandAdsView() {
    ...
    useEffect(() => {
        ...
        return () => window?.removeEventListener('reload:brand-ads', getData);
    }, [sortBy]);

    const getData = async () => {
        try {
            const response = await fetch({
                endpoint: `/campaigns/advertisements?all=true`,
                method: 'GET',
            });
            const sortedData = sortData(response?.ads || [], sortBy);
    ...
    return (
        <Content activePage='Brand Advertisements' pageTitle="Advertisements">
