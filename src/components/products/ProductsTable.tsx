...
import { PRODUCT_REVIEW_OPTIONS, PRODUCT_STATUS_OPTIONS, ROLES } from "@/_config";
                ...
                <Td textAlign='right' whiteSpace='nowrap'>
                    {
                        isSelectable
                            ...
                            : <>
                                <Tooltip label='View Looks' placement="bottom">
                                    <IconButton
                                        aria-label='View Looks'
                                        variant='solid'
                                        rounded='full'
                                ...
                                <Tooltip label='View Creators' placement="bottom">
                                    <IconButton
                                        aria-label='View Creators'
                                        variant='solid'
                                        rounded='full'
